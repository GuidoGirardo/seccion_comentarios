<?php
    ...
    if(isset($_POST['postear_comentario'])){
        ...
        $sql = "INSERT INTO video3 (nombre, comentario) VALUES ('$nombre', '$comentario')";
        if($conn->query($sql) === true) header("Location: http://localhost/xampp/scomentarios/pagina3.php");
...
<body>
            ...
            <?php
                ...
                if($result->num_rows > 0){
                    while($row = $result->fetch_assoc()){
                        ...
                        echo "<button class='btnLike' video='video3' data-id='{$row['id']}'>LIKE</button>";
                        echo "<button class='btnDislike' video='video3' data-id='{$row['id']}'>DISLIKE</button>";
                        echo "</div>";
                    }
                }
            ?>
    ...
    <div id="div2">
        <article id="otros">
            ...
            <a href="http://localhost/xampp/scomentarios/pagina2.php" class="video" id="v3">V2</a>
